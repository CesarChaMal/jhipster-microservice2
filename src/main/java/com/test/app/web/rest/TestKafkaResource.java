...
import com.test.app.config.KafkaProperties;
...
public class TestKafkaResource {
    ...
    private final Logger log = LoggerFactory.getLogger(TestKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public TestKafkaResource(KafkaProperties kafkaProperties) {
